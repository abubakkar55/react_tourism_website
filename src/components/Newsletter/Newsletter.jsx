            ...
            <div className="container py-14 md:py-0 md:h-72 mx-auto px-6  md:px-36 flex flex-col md:flex-row  md:items-center md:justify-between">
                ...
                <div className="mt-10 md:mt-0 md:ml-10">
                    <form>
                        ...
                        <input onClick={(e) => e.preventDefault() } className="bg-crimson-500 text-white mt-4 md:mt-0  px-6 py-3 rounded-md font-semibold hover:bg-puerto-600" type="submit" value="Subscribe" />
                    </form>
                </div>
            </div>
        </div>
